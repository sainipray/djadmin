...
if (e + i.innerWidth() > a(window).width() ? f = "right" : e - i.innerWidth() + g.innerWidth() < 0 && (f = "left"), "left" === f)c = h.gutter, leftPosition = g.position().left + c; else if ("right" === f) {
...
position: "",
"z-index": ""
}), i.removeClass("active"), f = !0, a(this).remove()
}
})
}
...
if (13 === b.which)
return void f.find("li").first().click();
...
var j = "";
return h && (j = ' class="' + h + '"'),
"multiple" === d ? i.append(a('<li class="' + e + '"><img src="' + g + '"' + j + '><span><input type="checkbox"' + e + "/><label></label>" + c.html() + "</span></li>")) : i.append(a('<li class="' + e + f + '"><img src="' + g + '"' + j + "><span>" + c.html() + "</span></li>")),
!0
}
"multiple" === d ? i.append(a('<li class="' + e + '"><span><input type="checkbox" class="filled-in"' + e + "/><label></label>" + c.html() + "</span></li>")) : i.append(a('<li class="' + e + f + '"><span>' + c.html() + "</span></li>"))
};
